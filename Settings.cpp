...
void SetupSettings(HWND hwnd, HINSTANCE hInstance,const CUSTOM_FRAME& frame, const SETTINGS& settings, HFONT &settings_font) {
	...
	SendMessageW(language_combo, CB_ADDSTRING, LANGUAGE_MANAGER::LANGUAGE::SPANISH, (LPARAM)L"Espa隳l");//INFO: this strings will not change with langs, each lang will be written like it should
