...
#undef SCV_LOAD_ENUM_MEMBER_TO_COMBO
	...
	//SendMessageW(language_combo, CB_ADDSTRING, (WPARAM)LANGUAGE_MANAGER::LANGUAGE::ESPA埆L, (LPARAM)L"Espa隳l");//INFO: this strings will not change with langs, each lang will be written like it should
